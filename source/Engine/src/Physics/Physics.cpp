...
namespace Engine
{
  ...
  //      if (entityA != entt::null) DispatchCollision(entityA, entityB, CollisionType::Exit, wasTrigger);
  //      if (entityB != entt::null) DispatchCollision(entityB, entityA, CollisionType::Exit, wasTrigger);
  //    }
  //  }
