...
2.1 Fixed Issues
    ...
    [FBXX-1707] Security improvements
...
2020.3.5
    ...
    [FBXX-1679]
    [FBXX-1678] Security improvements
    [FBXX-1677] Improve handling of Transparency values by allowing the use of the dissolve parameter (opacity) or
                the transmission color and factor. By default the transmission values are stored.
                To use the dissolve factor instead, users will need to set the EXP_OBJ_USE_DISSOLVE_FACTOR iosetting
                before exporting to the OBJ file.
